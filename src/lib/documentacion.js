...
export function documentoRequisitos(proyecto, requerimientosEspecificos, requerimientosGenerales, actores) {
        ...
        content: [
            ...
            {text: '2. Introducción\n\n', style: 'tableHeader'},
            {
                stack: [
                    ...
                    objetivos_sistema,'\n',
                    {text: '2.3. Vision general del documento:\n\n', style: 'tableHeader'},
                    vision_general_documento,'\n',
                    {text: '2.4. Funciones del sistema:\n\n', style: 'tableHeader'},
                ],
                style: 'pointMargin'
            },
            {
            ...
            {
                stack: [
                    {text: '2.6. Restricciones:\n\n', style: 'tableHeader'},
                    restricciones,'\n',
                    {text: '2.7. Suposiciones y dependencias:\n\n', style: 'tableHeader'},
    ...
    const listarRequisitosFuncionales = () => {
        ...
        requerimientosFuncionales.map(req => {
            json.content.push(tablaNumeracion(i), req.nombre)
    ...
    const jsonRequisito = {
        ...
        table: {
            ...
            body: [
                ...
                [
                    {text: `REQ-FUN${req.numeracion}`, style: 'reqContent'}, 
...
const tablaNumeracion = (num, nombre) => {
    return {text: `3.1.${num}. ${nombre} \n\n`, style: 'reqTitleTable'}
}
